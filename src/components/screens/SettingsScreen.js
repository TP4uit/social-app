...
const SETTINGS_SECTIONS = [
  {
    title: 'Account',
    data: [
      { id: 'personal_info', label: 'Personal Information', icon: '👤', type: 'navigate', screen: 'EditProfile' }, // Giả sử có màn hình EditProfile
      { id: 'password_security', label: 'Password & Security', icon: '🔒', type: 'navigate', screen: 'PasswordSettings' },
      { id: 'payment_methods', label: 'Payment Methods', icon: '💳', type: 'navigate', screen: 'PaymentMethods' },
    ],
  },
  {
    title: 'Privacy & Security',
    data: [
      { id: 'privacy_settings', label: 'Privacy Settings', icon: '🛡️', type: 'navigate', screen: 'PrivacyOptions' },
      { id: 'blocked_users', label: 'Blocked Users', icon: '👥', type: 'navigate', screen: 'BlockedUsers' },
      { id: 'two_factor', label: 'Two-Factor Authentication', icon: '🔑', type: 'navigate', screen: 'TwoFactorAuth' },
    ],
  },
  {
    title: 'Notifications',
    data: [
      { id: 'push_notifications', label: 'Push Notifications', icon: '🔔', type: 'navigate', screen: 'PushNotificationSettings' },
      { id: 'email_notifications', label: 'Email Notifications', icon: '✉️', type: 'navigate', screen: 'EmailNotificationSettings' },
    ],
  },
  {
    title: 'Preferences',
    data: [
      { id: 'language', label: 'Language', icon: '🌐', type: 'value_navigate', value: 'English', screen: 'LanguageSettings' },
      { id: 'dark_mode', label: 'Dark Mode', icon: '🌙', type: 'switch', stateKey: 'darkModeEnabled' },
    ],
  },
  {
    title: 'Support',
    data: [
      { id: 'help_center', label: 'Help Center', icon: '❓', type: 'navigate', screen: 'HelpCenter' },
      { id: 'contact_support', label: 'Contact Support', icon: '🎧', type: 'navigate', screen: 'ContactSupport' },
    ],
  },
  {
    title: 'About',
    data: [
      { id: 'terms_service', label: 'Terms of Service', icon: '📄', type: 'navigate', screen: 'TermsOfService' },
      { id: 'privacy_policy', label: 'Privacy Policy', icon: '📄', type: 'navigate', screen: 'PrivacyPolicy' },
      { id: 'app_version', label: 'App Version', icon: 'ℹ️', type: 'value_only', value: '1.2.3' },
    ],
  },
];
...
const SettingsScreen = ({ navigation }) => {
  ...
  const SettingItem = ({ item }) => (
    <TouchableOpacity
      ...
      onPress={() => item.type === 'navigate' || item.type === 'value_navigate' ? navigation.navigate(item.screen) : {}}
    ...
    >
      ...
      <View style={styles.itemRightContainer}>
        ...
        {(item.type === 'value_navigate' || item.type === 'value_only') && item.value && (
